...
/// <summary>
/// Читает «зону кропа» из маркированного изображения: ищет красный прямоугольник (нарисованный вручную),
/// вычисляет MinAreaRect (поддерживает наклон), возвращает трансформацию для применения к исходному изображению.
/// </summary>
public static class ZonaCropService
{
    ...
    // ----------------------------------------------------------------
    // Определить красный прямоугольник в zona-изображении
    // ----------------------------------------------------------------
